...
var _setLists = require('./setLists.uiMap');
...
/**
 * @class SetLists_page
 * @summary This page object represents /setlists
 * @extends BasePage
 */

var SetLists_page = function (_BasePage) {
    _inherits(SetLists_page, _BasePage);

    _createClass(SetLists_page, [{
        key: 'name',
    ...
    function SetLists_page() {
        _classCallCheck(this, SetLists_page);

        var _this = _possibleConstructorReturn(this, (SetLists_page.__proto__ || Object.getPrototypeOf(SetLists_page)).call(this));

        _elements = new _setLists2.default();
        return _this;
    }
    ...
    return SetLists_page;
}(_base2.default);

exports.default = SetLists_page;